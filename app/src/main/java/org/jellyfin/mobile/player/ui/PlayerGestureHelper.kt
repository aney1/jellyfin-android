...
class PlayerGestureHelper(
    ...
    /**
     * The region a vertical swipe gesture operates on, locked when the gesture starts.
     *
    ...
    private val gestureDetector = GestureDetector(
        ...
        object : GestureDetector.SimpleOnGestureListener() {
            ...
            override fun onScroll(
                ...
                // Handle vertical swipe for brightness/volume/fullscreen
                if (!isVerticalSwipe) {
                    return false
                }
    ...
    /**
     * Classify which region a vertical swipe starting at [swipeX] belongs to.
     *
