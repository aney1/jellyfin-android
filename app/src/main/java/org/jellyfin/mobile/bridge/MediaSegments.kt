...
class MediaSegments(
    ...
    fun getSupportedSegmentTypes(): String {
        // Serialize as a JSON array of segment type serial names (e.g. ["Intro","Outro"]).
        // Done manually to avoid pulling in a kotlinx-serialization-json dependency.
        return MediaSegmentRepository.SUPPORTED_TYPES.joinToString(
            separator = ",",
            prefix = "[",
            postfix = "]",
